...
#popupRiwayatMesin .popup-content {
  width: 90%;
  max-width: 1100px; /* bisa kamu ubah ke 1000–1200px sesuai selera */
  overflow-x: auto;
  max-height: 85vh;
}
...
<div class="popup" id="popupHapus">
  <div class="popup-content" style="width:380px; text-align:center;">
    ...
    <div style="display:flex; justify-content:center; gap:15px;">
      <button id="btnHapusYa" style="background:#e74c3c; border:none; color:white; padding:8px 14px; border-radius:6px; cursor:pointer;">Ya, Hapus</button>
      <button onclick="closeHapusPopup()" style="background:#ccc; border:none; color:#333; padding:8px 14px; border-radius:6px; cursor:pointer;">Batal</button>
    </div>
  </div>
</div>
