...
<head>
    ...
    text-align: left;
    table-layout: fixed; /* biar kolom konstan */
}
        ...
        .close-btn2 {
            ...
            color: #909090;
            cursor: pointer;
            z-index: 10000; /* pastikan di atas semua isi popup */
        }
...
<body>
    ...
    if (visible === 0) {
        if (!emptyRow) {
            ...
            emptyRow.innerHTML = `<td colspan="3" style="text-align:center; color:#888;">Tidak ada mesin yang cocok.</td>`;
