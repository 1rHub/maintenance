...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['ambil_laporan'])) {
    ...
    // kalau tidak ada mekanik baru dipilih, ambil dari data lama (misalnya dari status ditunda)
    ...
    // ubah status jadi proses agar mekanik bisa lanjut kerja
    $sql = "UPDATE laporan 
...
<body>
    ...
    <div id="popupDetail" class="popup">
        <div class="popup-content">
            <span class="close" onclick="closePopup('popupDetail')">&times;</span>
            ...
            <div id="mekanikList">
                <label><input type="checkbox" name="nama_mekanik[]" value="Mekanik Affan"> Mekanik Affan</label>
                <label><input type="checkbox" name="nama_mekanik[]" value="Mekanik Amar"> Mekanik Amar</label>
                <label><input type="checkbox" name="nama_mekanik[]" value="Mekanik Ibad"> Mekanik Ibad</label>
                <label><input type="checkbox" name="nama_mekanik[]" value="Mekanik Ijul"> Mekanik Ijul</label>
            </div>
