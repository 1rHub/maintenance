...
ORDER BY l.tanggal DESC;
    ...
    <div class="popup-content form-popup">
        ...
        <form method="POST">
            ...
            <input type="text" name="nama" placeholder="Masukkan nama pelapor" required>
            ...
            <textarea name="pesan" rows="3" placeholder="Tuliskan deskripsi kerusakan..." required></textarea>
...
<style>
    ...
    .form-popup textarea:focus {
        border-color: #39c6ed;
        box-shadow: 0 0 6px rgba(57,198,237,0.4);
    }
    ...
    .btn-submit {
        ...
        font-size: 15px;
        box-shadow: 0 4px 10px rgba(57,198,237,0.3);
    }

    .btn-submit:hover {
        background: #2da8cf;
        box-shadow: 0 6px 14px rgba(57,198,237,0.4);
